	...
	*/
	...
	public:
		...
		*/
		...
		void ReadFromFile(const boost::filesystem::path disk_file_name, const double pressure_from_input_file);
		...
		const std::vector<double>& north_pressure() const { return north_pressure_; }
		const std::vector<double>& south_pressure() const { return south_pressure_; }
		const std::vector<double>& east_pressure() const { return east_pressure_; }
		const std::vector<double>& west_pressure() const { return west_pressure_; }
	...
	protected:
		...
		std::vector<double> north_pressure_;
		std::vector<double> south_pressure_;
		std::vector<double> east_pressure_;
		std::vector<double> west_pressure_;
