...
namespace CVI
{
	...
	*/
	...
	public:
		...
		*/
		void SetGasSide(const double T_gas, const double P_gas, const OpenSMOKE::OpenSMOKEVectorDouble& omega_gas);
		...
		*/
		void SetInitialConditions(const double T_initial, const double P_initial, const OpenSMOKE::OpenSMOKEVectorDouble& omega_initial);
